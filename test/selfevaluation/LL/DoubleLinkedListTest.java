...
public class DoubleLinkedListTest {
    ...
    public void whenInsertInvalidDataAfterGivenNodeInDLLThenThrowException(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, DoubleLinkedList list)
    {
    ...
    public void whenInsertDataInEmptyInDLLThenAddNode(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, DoubleLinkedList list)
    {
        doubleLinkedListOps.setDoubleLinkedList(list);
        doubleLinkedListOps.insertAfterGivenNode(nodeValueToBeAdded, nodeValueToBeAddedAfter);
    ...
    public void whenInsertDataAfterNonExistantNodeInDLLThenThrowException(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
    ...
    public void whenInsertDataAfterFirstDLLThenAddNode(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
        doubleLinkedListOps.insertAfterGivenNode(nodeValueToBeAdded,nodeValueToBeAddedAfter);
    ...
    @Test(dataProvider = "listData")
    public void whenInsertDataAfterEndDLLThenAddNode(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
        doubleLinkedListOps.insertAfterGivenNode(nodeValueToBeAdded,nodeValueToBeAddedAfter);
    ...
    //invalid
    @Test(dataProvider = "InvalidData", expectedExceptions = IllegalArgumentException.class)
    public void whenInsertInvalidDataBeforeGivenNodeInDLLThenThrowException(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, DoubleLinkedList list)
    {
        doubleLinkedListOps.setDoubleLinkedList(list);
    ...
    //empty
    @Test(dataProvider = "EmptyData")
    public void whenInsertDataBeforeInEmptyInDLLThenAddNode(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, DoubleLinkedList list)
    {
        doubleLinkedListOps.setDoubleLinkedList(list);
        doubleLinkedListOps.insertBeforeGivenNode(nodeValueToBeAdded, nodeValueToBeAddedAfter);
    ...
    @Test(dataProvider = "nonExistantData", expectedExceptions = RuntimeException.class)
    public void whenInsertDataBeforeNonExistantNodeInDLLThenThrowException(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
        doubleLinkedListOps.insertBeforeGivenNode(nodeValueToBeAdded,nodeValueToBeAddedAfter);
    }
    ...
    @Test(dataProvider = "listData")
    public void whenInsertDataBeforeFirstDLLThenAddNode(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
        doubleLinkedListOps.insertBeforeGivenNode(nodeValueToBeAdded,nodeValueToBeAddedAfter);
    ...
    @Test(dataProvider = "listData")
    public void whenInsertDataBeforeEndDLLThenAddNode(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(0);
    ...
    //invalid
    @Test(dataProvider = "InvalidData", expectedExceptions = IllegalArgumentException.class)
    public void whenInsertInvalidDataAtEndInDLLThenThrowException(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, DoubleLinkedList list)
    {
        doubleLinkedListOps.setDoubleLinkedList(list);
    ...
    //empty
    @Test(dataProvider = "EmptyData")
    public void whenInsertDataAtEndInEmptyInDLLThenAddNode(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, DoubleLinkedList list)
    {
        doubleLinkedListOps.setDoubleLinkedList(list);
        doubleLinkedListOps.insertAtEnd(nodeValueToBeAdded);
    ...
    @Test(dataProvider = "listData")
    public void whenInsertDataAtEndOfSingleElementDLLThenAddNode(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
        doubleLinkedListOps.insertAtEnd(nodeValueToBeAdded);
    ...
    public void whenDeleteFirstNodeInEmptyInDLLThenThrowException(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, DoubleLinkedList list)
    {
        doubleLinkedListOps.setDoubleLinkedList(list);
    ...
    //single
    @Test(dataProvider = "listData")
    public void whenDeleteFirstNodeInSingleElementDLLThenDeleteList(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
        doubleLinkedListOps.deleteFirstNode();
    ...
    //multi element list
    @Test(dataProvider = "listData")
    public void whenDeleteFirstNodeInMultiElementDLLThenDeleteNode(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
        doubleLinkedListOps.insertAtEnd(nodeValueToBeAdded);
        doubleLinkedListOps.deleteFirstNode();
    ...
    //empty
    @Test(dataProvider = "EmptyData", expectedExceptions = RuntimeException.class)
    public void whenDeleteLastNodeInEmptyInDLLThenThrowException(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, DoubleLinkedList list)
    {
        doubleLinkedListOps.setDoubleLinkedList(list);
    ...
    //single
    @Test(dataProvider = "listData")
    public void whenDeleteLastNodeInSingleElementDLLThenDeleteList(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
        doubleLinkedListOps.deleteLastNode();
    ...
    //multi element list
    @Test(dataProvider = "listData")
    public void whenDeleteLastNodeInMultiElementDLLThenDeleteNode(int nodeValueToBeAdded, int nodeValueToBeAddedAfter, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
        doubleLinkedListOps.insertAtEnd(nodeValueToBeAdded);
        doubleLinkedListOps.deleteLastNode();
    ...
    //invalid
    @Test(dataProvider = "InvalidData", expectedExceptions = IllegalArgumentException.class)
    public void whenDeleteInvalidDataInDLLThenThrowException(int nodeValueToBeDeleted, int nodeValueToBeDeletedBefore, DoubleLinkedList list)
    {
        doubleLinkedListOps.setDoubleLinkedList(list);
    ...
    public void whenDeleteInEmptyInDLLThenThrowException(int nodeValueToBeDeleted, int nodeValueToBeDeletedBefore, DoubleLinkedList list)
    {
        doubleLinkedListOps.setDoubleLinkedList(list);
        doubleLinkedListOps.deleteNode(nodeValueToBeDeleted);
    }
    ...
    //single element case
    @Test(dataProvider = "listData")
    public void whenDeleteInSingleElementDLLThenDeleteList(int nodeValueToBeDeleted, int nodeValueToBeDeletedBefore, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
    ...
    public void whenDeleteBeforeNonExistantInDLLThenThrowException(int nodeValueToBeDeleted, int nodeValueToBeDeletedBefore, int seedValue)
    {
        doubleLinkedListOps.insertAtFront(seedValue);
        doubleLinkedListOps.insertAtEnd(2);
        doubleLinkedListOps.deleteNode(nodeValueToBeDeleted);
